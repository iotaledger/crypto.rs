...
[
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 1]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 1, 2]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 1, 2, 2]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 1, 2, 2, 1000000000]),
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 2147483647]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 2147483647, 1]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 2147483647, 1, 2147483646]),
            ...
            TestChain {
                chain: Chain::from_segments_hardened([0, 2147483647, 1, 2147483646, 2]),
