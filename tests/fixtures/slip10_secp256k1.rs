[
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, true)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, true), (1, false)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, true),  (1, false), (2, true)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, true),  (1, false), (2, true), (2, false)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, true),  (1, false), (2, true), (2, false), (1000000000, false)]),
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, false)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, false), (2147483647, true)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, false), (2147483647, true), (1, false)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, false), (2147483647, true), (1, false), (2147483646, true)]),
            ...
            TestChain {
                chain: Chain::from_u32_mixed(vec![(0, false), (2147483647, true), (1, false), (2147483646, true), (2, false)]),
