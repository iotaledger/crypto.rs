...
[
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_segments([u32::HARDEN_MASK | 0]),
            ...
            TestChain {
                chain: Chain::from_segments([u32::HARDEN_MASK | 0, 1]),
            ...
            TestChain {
                chain: Chain::from_segments([u32::HARDEN_MASK | 0, 1, u32::HARDEN_MASK | 2]),
            ...
            TestChain {
                chain: Chain::from_segments([u32::HARDEN_MASK | 0, 1, u32::HARDEN_MASK | 2, 2]),
            ...
            TestChain {
                chain: Chain::from_segments([u32::HARDEN_MASK | 0, 1, u32::HARDEN_MASK | 2, 2, 1000000000]),
    ...
    TestVector {
        ...
        chains: vec![
            ...
            TestChain {
                chain: Chain::from_segments([0, u32::HARDEN_MASK | 2147483647]),
            ...
            TestChain {
                chain: Chain::from_segments([0, u32::HARDEN_MASK | 2147483647, 1]),
            ...
            TestChain {
                chain: Chain::from_segments([0, u32::HARDEN_MASK | 2147483647, 1, u32::HARDEN_MASK | 2147483646]),
            ...
            TestChain {
                chain: Chain::from_segments([0, u32::HARDEN_MASK | 2147483647, 1, u32::HARDEN_MASK | 2147483646, 2]),
